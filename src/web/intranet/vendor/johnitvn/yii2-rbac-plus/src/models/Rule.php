...
class Rule extends Model {
    ...
    public function unique() {
        ...
        $value = $this->name;
        if ($authManagerldap->getRule($value) !== null) {
    ...
    public static function find($id) {
        $item = Yii::$app->authManagerldap->getRule($id);
        if ($item !== null) {
    ...
    public function save() {
        ...
        $manager = Yii::$app->authManagerldap;
    ...
    public function delete() {
        ...
        $authManagerldap = Yii::$app->authManagerldap;
        return $authManagerldap->remove($this->item);
    }
